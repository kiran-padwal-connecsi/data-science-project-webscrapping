...
def get_all_historical_data(url):
    print(url)
    if url == 'coinmarketcap.com':
        conObj = CoinmarketcapController()
        conObj.get_all_historical_data()
    else:
        print('not matched url')

get_all_historical_data('coinmarketcap.com')
...
#getHistoryData(url='coinmarketcap.com')
# def periodic_task():
...
#schedule.every().day.at("06:00").do(getDailyData,'coinmarketcap.com')
