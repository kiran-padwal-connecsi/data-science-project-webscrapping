...
getMinuteData('coinmarketcap.com')
...
#schedule.every().day.at("04:00").do(getMinuteData,'coinmarketcap.com')
# schedule.every(60).minutes.do(getMinuteData,'coinmarketcap.com')
